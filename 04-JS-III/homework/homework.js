...
function agregarNumeros(numeros) {
  ...
  // Tu código:
  var sum = 0;
  for (let index = 0; index < numeros.legth; index++) {
...
function promedioResultadosTest(resultadosTest) {
  ...
  // Tu código:
  agregarNumeros(resultadosTest) / resultadosTest.length
}
...
function mesesDelAño(array) {
  ...
  var nuevoArray = [];
  for (let index = 0; index < array.length; index++) {
    if (let [index] = "Enero" || array[index] === "Marzo" || array[index] === "Noviembre") {
...
function continueStatement(numero) {
  ...
  var otroArray = [];
  var suma = numero;
  for (let index = 0; index < otroArra; index++) {
    if(index === 5) {
      continue;
    }
    else {
